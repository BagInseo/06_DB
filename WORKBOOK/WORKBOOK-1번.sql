--1번 춘 기술대학교의 학과 이름과 계열을 조회
--단, 출력 헤더(컬럼명)는 '학과 명','계열'으로 표시하도록 한다. 
SELECT DEPARTMENT_NAME "학과 명" ,CATEGORY "계열" 
FROM TB_DEPARTMENT ;


--2번 학과의 학과 정원을 다음과 같은 형태로 조회하시오
...
--5번 입합 정워이 20명 이상 30명 이하인 학과들의 학과 이름과 계열을 조회하시오
...
--6번 춘 기술대학교는 총장을 제외하고 모든 교수들의 소속 학과를 가지고 있다
...
--7번 수강신청을 하려고 한다.
--선수과목 여부를 확인해야 하는데, 선수과목이 존재하는 과목들은
...
--8번 춘 대학에는 어떤 계열(CATEGORY)들이 있는지 조회해 보시오.
SELECT DISTINCT (CATEGORY) 
FROM TB_DEPARTMENT; 



--9번 02학번 전주 거주자들의 모임을 만들려고 한다. 
