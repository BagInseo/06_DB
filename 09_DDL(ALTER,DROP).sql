...
ALTER TABLE DEPT_COPY 
DROP CONSTRAINT  DEP_COPT_TITLE_U;

ALTER TABLE DEPT_COPY 
DROP CONSTRAINT  LOCATION_ID_CK;

--NOT NULL 제약조건 DROP으로 되긴 함!!
ALTER TABLE DEPT_COPY 
DROP CONSTRAINT SYS_C007456;

-- NOT NULL 제거 시 MODIFY 사용
ALTER TABLE DEPT_COPY 
MODIFY LOCATION_ID CONSTRAINT SYS_C007457 NULL;
