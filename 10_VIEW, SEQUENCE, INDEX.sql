...
----------------------------------------------------------
/*WITH READ ONLY 옵션*/
--DEPARTMENT 테이블을 목사한 DEPT_COPY2 생성
...
INCREMENT BY 5 --NEXTVAL 호출 받아 5씩 증가
...
SELECT  SEQ_TEST_NO.CURRVAL FROM DUAL; --(오류 X)
...
--> CREATE 구문과 비슷하지만 START WITH  옵션만 제외함
...
--SEQ_TEST-NO 시뭔스의 최대값을 200으로 변경
...
/* INDEX(색인)-> 원하는 특정 요소나 데이터를 빨리 찾아가게 도와주는 것
