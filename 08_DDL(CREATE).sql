...
-- 주민번호 : MEMBER_SSN	/ 자료형 : CHAR(14)  (항상 14글자 고정 -> VARCHAR일 필요X)
...
VALUES ('MEM04','1Q23E4R','신짱구','960606-1234567');
...
-- 참조(REFERENCES)된 다른 테이블의 컬럼이 제공하는 값만 사용할 수 있음
 -->다른 테이블이 제공하는 컬럼에는 PK 또는 UNIQUE 제약 조건이 설정되어 있어야 한다!
...
--ORA-02291: 무결성 제약조건(KH_PIS.GRADE_CODE_FK1)이 위배되었습니다- 부모 키가 없습니다
...
-- ORA-02290: 체크 제약조건(KH_PIS.GANDER_CHECK)이 위배되었습니다
...
CREATE TABLE USER_TEST(
	...
	GENDER CHAR(3) CONSTRAINT CK_GENDE CHECK(GENDER IN ('남','여')),
	PHONE VARCHAR2(20),
	ADDRESS VARCHAR2(500),
	STATUS CHAR(1) CONSTRAINT NN_STATUS NOT NULL
...
COMMENT ON COLUMN USER_TEST.PNO IS '회원 주민번호';
COMMENT ON COLUMN USER_TEST.GENDER  IS '회원 성별';
COMMENT ON COLUMN USER_TEST.PHONE  IS '회원 전화번호';
COMMENT ON COLUMN USER_TEST.ADDRESS  IS '회원 주소';
COMMENT ON COLUMN USER_TEST.STATUS  IS '회원 탈퇴 여부';

SELECT * FROM USER_TEST;

INSERT INTO USER_TEST  VALUES(1,'USER01','QWER','010101-123456','남','010-1234-5678','경기도 고양시','Y');
INSERT INTO USER_TEST  VALUES(2,'USER02','QWER1234','010101-223456','여','010-2222-5678','경기도 수원','Y');
INSERT INTO USER_TEST  VALUES(3,'USER03','1234','990101-222222','여','010-1234-5678','서울 중구 남대문로','N');
INSERT INTO USER_TEST  VALUES(4,'USER04','1234ASDF','980101-133456','남','010-2222-3333','서울 종로 지봉로','N');
INSERT INTO USER_TEST  VALUES(5,'USER05','ASDFASDF','930401-253456','여','010-2222-1234','충청남도 천안시','N');
...
--> NOT NULL 제약조건을 제외한 다른 제약조건은 복사 X
--> +DEFAULT, COMMENT 복사X
